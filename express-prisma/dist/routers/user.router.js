...
class UserRouter {
    ...
    initializeRoutes() {
        this.router.get("/", verify_1.verifyToken, verify_1.checkaAdmin, this.userController.getUsers);
        ...
        this.router.patch("/avatar-cloud", verify_1.verifyToken, (0, uploader_1.Uploader)("memoryStorage", "avatar-", "/avatar").single("file"), this.userController.editAvatarCloud);
