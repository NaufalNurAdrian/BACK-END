    ...
    registerUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield (0, auth_service_1.findUser)(username, email);
                if (user)
                ...
                const compaileTemplate = handlebars_1.default.compile(templateSource);
                const html = compaileTemplate({ username, link });
                yield mailer_service_1.transport.sendMail({
    ...
    loginUser(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const user = yield (0, auth_service_1.findUser)(data, data);
                if (!user)
